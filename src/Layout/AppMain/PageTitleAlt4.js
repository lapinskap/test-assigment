...
class PageTitleAlt4 extends Component {
  randomize(myArray) {
  ...
  render() {
    ...
    const arr = [<TitleComponent1 />, <TitleComponent2 />, <TitleComponent3 />];
...
export default connect(mapStateToProps, mapDispatchToProps)(PageTitleAlt4);
